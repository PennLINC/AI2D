...
<tr><th style="font-weight:bold; width: 250px;">Demographics</th><th style="font-weight:normal"><a href="{{ page.demo_data }}">{{ page.demo_data }}</a></th><th style="font-weight:normal"></th></tr>
...
<tr><th style="font-weight:bold; width: 250px;"><a href="https://handbook.datalad.org/en/latest/intro/philosophy.html">BIDS Datalad Dataset</a></th><th style="font-weight:normal"><code>{{ page.bids_dl }}</code></th><th style="font-weight:normal"></th></tr>
