...
qsiprep_version:
qsirecon_version:
bids_dset: /cbica/projects/pennlinc_rbc/datasets/LINC_CCNP/BIDS
...
ncdlmuse_path: /cbica/projects/pennlinc_rbc/datasets/LINC_CCNP/derivatives/NCDLMUSE-0-1-4_volumes/group_ncdlmuse_volumes.tsv
xcpd_qc: /cbica/projects/pennlinc_rbc/datasets/LINC_CCNP/derivatives/QC/func/xcpd_qc/all_xcpd_qc_metrics.tsv
      ...
      <th style="font-weight:normal">
        <div class="tab-container">
          <div class="tab-buttons">
            ...
            <button class="tab-button" onclick="showTab('xcpd-qc')">fMRI QC</button>
          </div>
          ...
          <div id="xcpd-qc" class="tab-content">
...
function showTab(tabName) {
  // Determine which tab type was clicked (datalad, ephemeral, or qc)
  var tabType = tabName.includes('-dl') ? 'datalad' : (tabName.includes('-qc') ? 'qc' : 'ephemeral');
  ...
  if (tabType === 'datalad') {
    ...
    // Show all QC contents and activate all QC buttons
    var qcContents = document.querySelectorAll('[id$="-qc"]');
    var qcButtons = document.querySelectorAll('[onclick*="-qc"]');
    
    qcContents.forEach(function(content) {
      content.classList.add('active');
    });
    
    qcButtons.forEach(function(button) {
      button.classList.add('active');
    });
  } else {
...
*Funding*
<br>
Start-up Funds for Leading Talents - Beijing Normal University, 2019B030335001, NBSDC-DB-15, Z161100002616023, Z181100001518003, 20&ZD296, 153111KYSB20160020, 201621, 2015CB351702, 8122010801, KSZD-EW-TZ-002, 2015CB351702, [NIMH R01MH120482](https://reporter.nih.gov/search/e9_-eAc68EOR6N2XajbTiQ/project-details/10626901).
