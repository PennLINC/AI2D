...
<div class="table" align="center">
  <table style="text-align:center; width:100%; font-size:18px; border:1px solid black">
    ...
    <tr>
      <th style="font-weight:bold; width:250px;">CuBIDS</th>
      <th style="font-weight:normal">
        {% if page.cubids_url %}
          <a href="{{ page.cubids_url }}">{{ page.cubids }}</a>
        {% else %}
          {{ page.cubids }}
        {% endif %}
      </th>
    ...
    <tr>
      <th style="font-weight:bold; width:250px;">BABS</th>
    ...
    <tr>
      ...
      <th style="font-weight:normal">
        {% if page.t1qc_tsv %}
          <a href="{{ page.demo_data }}">View T1w QC</a>
        {% else %}
          Not available
        {% endif %}
        {% if page.t1qc_json %}
          <a href="{{ page.demo_data }}">, View T1w QC Variables</a>
        {% else %}
          Not available
        {% endif %}
                {% if page.t1qc_json %}
          <a href="{{ page.demo_data }}">, View RBC Paper for T1w QC Method</a>
        {% else %}
          Not available
        {% endif %}
      </th>
    ...
    <tr>
      <th style="font-weight:bold; width:250px;">
        <a href="{{ site.baseurl }}/docs/imaging/image_freesurferpost/">FreeSurfer-Post</a> {{ page.freesurferpost_version }}
        <br>
